...
@section('page-create')
    ...
    <a href="{{route('cities.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
                                ...
                                @if($cities->count()!=null)
                                    ...
                                    @foreach($cities as $city)
                                        ...
                                        <tr>
                                            ...
                                            <td class="" style="max-width: 30%">@if($city->country()){{$city->country->ar_title}}@endif</td>
