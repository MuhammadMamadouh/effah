...
@section('page-create')
    ...
    <a href="{{route('subcities.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @if($cities->count()!=null)
                                    ...
                                    <tr>
                                        ...
                                        <th class="">الاسم باللغة العربيه</th>
                                        <th class="">الاسم باللغة الانجليزية</th>
                                    ...
                                    @foreach($cities as $city)
                                        ...
                                        <tr>
                                            ...
                                            <td class="" style="max-width: 30%">{{$city->name_en}}</td>
                                            <td class="" style="max-width: 30%">@if($city->gov()){{$city->gov->name}}@endif</td>
                                       ...
                                       <td class="text-right">
                                            ...
                                            <td class="text-right">
                                                <a class="btn btn-sm btn-warning "
                                                   href="{{route('subcities.edit',$city->id)}}">
