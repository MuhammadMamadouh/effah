...
@section('page-create')
    {{-- اضافة زرار--}}
    <a href="{{route('careers.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
