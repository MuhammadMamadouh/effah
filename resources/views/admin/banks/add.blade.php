                    ...
                    <form class="form" method="post" action="{{route('bank.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-t-40 row @error('name') has-danger @enderror">
                            <label for="name-ar" class="col-2 col-form-label">{{trans('main.bank_name')}} <span
                                    class="text-danger">*</span></label>
                            <div class="col-10">
                                <input class="form-control @error('bank_name') form-control-danger @enderror" type="text" name="bank_name" id="bank_name" value="{{old('bank_name')}}"   required autocomplete="name"
                                       autofocus>
                        ...
                        <div class="form-group m-t-40 row @error('iban') has-danger @enderror">
                            <label for="name-ar" class="col-2 col-form-label">{{trans('main.bank_iban')}} <span
                                    class="text-danger">*</span></label>
                            <div class="col-10">
                                <input class="form-control @error('iban') form-control-danger @enderror" type="text" name="iban" id="name" value="{{old('iban')}}"   required autocomplete="name"
                                       autofocus>
                        ...
                        <div class="form-group m-t-40 row @error('number') has-danger @enderror">
                            <label for="name-ar" class="col-2 col-form-label">{{trans('main.bank_number')}} <span
                                    class="text-danger">*</span></label>
                            <div class="col-10">
                                <input class="form-control @error('number') form-control-danger @enderror" type="text" name="number" id="number" value="{{old('number')}}"   required autocomplete="name"
                                       autofocus>
