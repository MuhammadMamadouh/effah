...
@section('page-create')
    {{-- اضافة زرار--}}
    <a href="{{route('nationality.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <a class="btn btn-sm btn-warning "
                                               href="{{route('nationality.edit',$c->id)}}">
