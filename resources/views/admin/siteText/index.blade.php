...
@section('page-create')
    {{-- اضافة زرار--}}
{{--
    <a href="{{route('siteTexts.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
--}}
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @if($siteTexts->count()!=null)
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-xs-down">العنوان </th>
                                        <th class="hidden-xs-down">المحتوي </th>
                                    ...
                                    @foreach($siteTexts as $siteText)
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-xs-down">{{$siteText->title}}</td>
                                            <td class="hidden-xs-down" style="max-width: 30%">{{$siteText->content}}</td>
