...
@section('page-create')
    {{-- اضافة زرار--}}
    <a href="{{route('colleges.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
                            ...
                            @if($categories->count()!=null)
                                ...
                                @foreach($categories as $c)
                                    ...
                                    <tr>
                                        <td class=""> {{$count++}}</td>
                                        <td class=""> {{$c->name}}</td>
                                        <td class=""> {{$c->universty->name}}</td>


                                        <td class="">
                                            <a class="btn btn-sm btn-warning "
                                               href="{{route('colleges.edit',$c->id)}}">
