...
@section('page-create')
    ...
    <a href="{{route('answers.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                @if($answers->count()!=null)
                                    ...
                                    @foreach($answers as $country)

                                        <tr>
                                            <td class=""> {{$count++}}</td>
                                            <td class="" style="max-width: 30%">@if($country->question){{  \Illuminate\Support\Str::limit($country->question->content,40,$end='..')}}@endif</td>
                                     ...
                                     <td class="text-right">
                                       ...
                                       <td class="text-right">
                                                <a class="btn btn-sm btn-warning "
                                                   href="{{route('answers.edit',$country->id)}}">
