        ...
        <div class="col-12">
            <div class="card">
                <div class="card-block">
                    <form class="form" method="post" action="{{route('countries.update',$country->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input data-validation="required" type="text"  name="ar_title" id="ar_title" value="{{$country->ar_title}}" class="form-control"/>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input data-validation="required" type="text"  name="en_title" id="en_title" value="{{$country->en_title}}" class="form-control"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group m-t-40 row @error('phone_code') has-danger @enderror">
                            ...
                            <div class="col-10">
                                <input class="form-control @error('phone_code') form-control-danger @enderror" type="text" name="phone_code" id="email_code" value="{{$country->phone_code}}"   required autocomplete="phone"
                                       autofocus>
                        ...
                        <div class="form-group">
                            <label>العلم</label>
                            <input  type="file" name="flag" id="input-file-now-custom-1" class="dropify" data-default-file="{{asset('/').$country->flag}}" />
