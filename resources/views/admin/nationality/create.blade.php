        ...
        <div class="col-12">
            <div class="card">
                <div class="card-block">
                    <form class="forms-sample" method="post" action="{{route('nationality.store')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input data-validation="required" type="text"  name="fName" id="ar_title" value="{{old('fName')}}" class="form-control"/>
                                </div>
                            </div>
