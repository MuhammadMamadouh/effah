...
@section('page-create')
    {{-- اضافة زرار--}}
    <a href="{{route('subCategories.create')}}" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>{{trans('main.Create')}}</a>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            @if($categories->count()!=null)
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-xs-down">الاسم </th>
                                    <th class="hidden-xs-down">التصنيف الرئيسيس</th>


                                    <th class="hidden-xs-down">
                                        {{trans('main.Edit')}}
                                    </th>  <th class="hidden-xs-down">
                                        {{trans('main.Delete')}}
                                    </th>
                                ...
                                @foreach($categories as $c)
                                    ...
                                    <tr>
                                        <td class="hidden-xs-down"> {{$count++}}</td>
                                        <td class="hidden-xs-down"> {{$c->name}}</td>
                                        <td class="hidden-xs-down"> {{$c->category->name}}</td>


                                        <td class="">
                                            <a class="btn btn-sm btn-warning "
                                               href="{{route('subCategories.edit',$c->id)}}">
