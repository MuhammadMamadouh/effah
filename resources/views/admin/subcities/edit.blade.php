        ...
        <div class="col-12">
            <div class="card">
                <div class="card-block">
                    <form class="form" method="post" action="{{route('subcities.update',$city->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>اسم المدينة  باللغة الانجليزية</label>
                        ...
                        <div class="form-group m-t-40 row @error('en_title') has-danger @enderror">
                            <label for="name-ar" class="col-2 col-form-label">المحافظة<span
                                    class="text-danger">*</span></label>
                            <div class="col-10">
                                <select name="country_id"  class="form-control">
                                    @foreach($countries as $country)
                                        <option @if($city->city_id==$country->id)selected  @endif value=" {{$country->id}}">  {{$country->name}}</option>
                                      @endforeach
                                </select>
